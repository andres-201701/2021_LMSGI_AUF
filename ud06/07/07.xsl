...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>07 XSLT TEST 
                    <xsl:value-of select="//nombreModulo"/> Andrés de Uña</title>
            </head>
            <body>
                ...
                <h3><xsl:value-of select="concat('Fecha: ',//dia,' de ',document('meses.xml')//mes[@id=current()//mes]/text(),' de ',//anyo)"/></h3>
                <form axtion="test.php" method="get">
